...
package org.jouvieje.fmodex.wav;

import java.io.IOException;
import java.io.RandomAccessFile;
import java.nio.ByteBuffer;

import org.jouvieje.fmodex.utils.FileIOUtils;
...
public class DataChunk {
	 ...
	 */
	protected void write(RandomAccessFile raf, FileIOUtils io) throws IOException {
		chunk.write(raf, io);
	}
