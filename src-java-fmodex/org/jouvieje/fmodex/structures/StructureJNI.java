...
class StructureJNI {
	...
	protected final static native int FMOD_ADVANCEDSETTINGS_get_maxCELTcodecs(long pointer);
	protected final static native void FMOD_ADVANCEDSETTINGS_set_maxCELTcodecs(long pointer, int maxCELTcodecs);
	...
	protected final static native int FMOD_ADVANCEDSETTINGS_get_geometryMaxFadeTime(long pointer);
	protected final static native void FMOD_ADVANCEDSETTINGS_set_geometryMaxFadeTime(long pointer, int geometryMaxFadeTime);
	protected final static native int FMOD_ADVANCEDSETTINGS_get_maxSpectrumWaveDataBuffers(long pointer);
	protected final static native void FMOD_ADVANCEDSETTINGS_set_maxSpectrumWaveDataBuffers(long pointer, int maxSpectrumWaveDataBuffers);

						/* FMOD_ASYNCREADINFO */

	protected final static native long FMOD_ASYNCREADINFO_new();
	protected final static native void FMOD_ASYNCREADINFO_delete(long pointer);
	protected final static native long FMOD_ASYNCREADINFO_get_handle(long pointer);
	protected final static native int FMOD_ASYNCREADINFO_get_offset(long pointer);
	protected final static native int FMOD_ASYNCREADINFO_get_sizebytes(long pointer);
	protected final static native int FMOD_ASYNCREADINFO_get_priority(long pointer);
	protected final static native long FMOD_ASYNCREADINFO_get_buffer(long pointer);
	protected final static native void FMOD_ASYNCREADINFO_set_buffer(long pointer, long buffer);
	protected final static native int FMOD_ASYNCREADINFO_get_bytesread(long pointer);
	protected final static native void FMOD_ASYNCREADINFO_set_bytesread(long pointer, int bytesread);
	protected final static native int FMOD_ASYNCREADINFO_get_result(long pointer);
	protected final static native void FMOD_ASYNCREADINFO_set_result(long pointer, int result);
	protected final static native long FMOD_ASYNCREADINFO_get_userdata(long pointer);
	...
	protected final static native int FMOD_CODEC_STATE_invoke_metadata(long pointer, long codec_state, int tagtype, byte[] name, long data, int datalen, int datatype, int unique);
	...
	protected final static native void FMOD_CREATESOUNDEXINFO_set_userasyncread(long pointer, boolean userasyncread);
	protected final static native void FMOD_CREATESOUNDEXINFO_set_userasynccancel(long pointer, boolean userasynccancel);
	...
	protected final static native int FMOD_CREATESOUNDEXINFO_get_ignoresetfilesystem(long pointer);
	protected final static native void FMOD_CREATESOUNDEXINFO_set_ignoresetfilesystem(long pointer, int ignoresetfilesystem);
	...
	protected final static native void FMOD_DSP_DESCRIPTION_set_paramdesc(long pointer, long paramdesc, int paramdescLen_);
	...
	protected final static native long FMOD_MEMORY_USAGE_DETAILS_new();
	protected final static native void FMOD_MEMORY_USAGE_DETAILS_delete(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_other(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_string(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_system(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_plugins(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_output(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_channel(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_channelgroup(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_codec(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_file(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_sound(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_secondaryram(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_soundgroup(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_streambuffer(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_dspconnection(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_dsp(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_dspcodec(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_profile(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_recordbuffer(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_reverb(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_reverbchannelprops(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_geometry(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_syncpoint(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventsystem(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_musicsystem(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_fev(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_memoryfsb(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventproject(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventgroupi(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_soundbankclass(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_soundbanklist(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_streaminstance(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_sounddefclass(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_sounddefdefclass(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_sounddefpool(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_reverbdef(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventreverb(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_userproperty(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventinstance(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventinstance_complex(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventinstance_simple(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventinstance_layer(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventinstance_sound(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventenvelope(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventenvelopedef(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventparameter(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventcategory(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventenvelopepoint(long pointer);
	protected final static native int FMOD_MEMORY_USAGE_DETAILS_get_eventinstancepool(long pointer);
	...
	protected final static native long FMOD_VECTOR_allocate(float x, float y, float z);
