...
class EnumerationJNI {
	...
	protected final static native int get_FMOD_CHANNEL_CALLBACKTYPE_OCCLUSION();
	...
	protected final static native int get_FMOD_DELAYTYPE_DSPCLOCK_PAUSE();
	...
	protected final static native int get_FMOD_DSP_DELAY_CH0();
	protected final static native int get_FMOD_DSP_DELAY_CH1();
	protected final static native int get_FMOD_DSP_DELAY_CH2();
	protected final static native int get_FMOD_DSP_DELAY_CH3();
	protected final static native int get_FMOD_DSP_DELAY_CH4();
	protected final static native int get_FMOD_DSP_DELAY_CH5();
	protected final static native int get_FMOD_DSP_DELAY_CH6();
	protected final static native int get_FMOD_DSP_DELAY_CH7();
	protected final static native int get_FMOD_DSP_DELAY_CH8();
	protected final static native int get_FMOD_DSP_DELAY_CH9();
	protected final static native int get_FMOD_DSP_DELAY_CH10();
	protected final static native int get_FMOD_DSP_DELAY_CH11();
	protected final static native int get_FMOD_DSP_DELAY_CH12();
	protected final static native int get_FMOD_DSP_DELAY_CH13();
	protected final static native int get_FMOD_DSP_DELAY_CH14();
	protected final static native int get_FMOD_DSP_DELAY_CH15();
	protected final static native int get_FMOD_DSP_DELAY_MAXDELAY();
	...
	protected final static native int get_FMOD_DSP_TREMOLO_FREQUENCY();
	protected final static native int get_FMOD_DSP_TREMOLO_DEPTH();
	protected final static native int get_FMOD_DSP_TREMOLO_SHAPE();
	protected final static native int get_FMOD_DSP_TREMOLO_SKEW();
	protected final static native int get_FMOD_DSP_TREMOLO_DUTY();
	protected final static native int get_FMOD_DSP_TREMOLO_SQUARE();
	protected final static native int get_FMOD_DSP_TREMOLO_PHASE();
	protected final static native int get_FMOD_DSP_TREMOLO_SPREAD();
	...
	protected final static native int get_FMOD_DSP_TYPE_DELAY();
	protected final static native int get_FMOD_DSP_TYPE_TREMOLO();
	...
	protected final static native int get_FMOD_OPENSTATE_SETPOSITION();
	...
	protected final static native int get_FMOD_OUTPUTTYPE_PULSEAUDIO();
	...
	protected final static native int get_FMOD_ERR_INVALID_POSITION();
	protected final static native int get_FMOD_ERR_INVALID_SPEAKER();
	protected final static native int get_FMOD_ERR_INVALID_SYNCPOINT();
	...
	protected final static native int get_FMOD_ERR_PRELOADED();
	protected final static native int get_FMOD_ERR_PROGRAMMERSOUND();
	...
	protected final static native int get_FMOD_ERR_EVENT_NEEDSSIMPLE();
	protected final static native int get_FMOD_ERR_EVENT_GUIDCONFLICT();
	protected final static native int get_FMOD_ERR_EVENT_ALREADY_LOADED();
	protected final static native int get_FMOD_ERR_MUSIC_UNINITIALIZED();
	protected final static native int get_FMOD_ERR_MUSIC_NOTFOUND();
	protected final static native int get_FMOD_ERR_MUSIC_NOCALLBACK();
	...
	protected final static native int get_FMOD_SOUND_FORMAT_CELT();
	...
	protected final static native int get_FMOD_SOUND_TYPE_AUDIOQUEUE();
	protected final static native int get_FMOD_SOUND_TYPE_XWMA();
	...
	protected final static native int get_FMOD_SPEAKERMAPTYPE_51_PROTOOLS();
	...
	protected final static native int get_FMOD_SYSTEM_CALLBACKTYPE_BADDSPLEVEL();
