...
class FmodExJNI {
	...
	protected final static native int Channel_setLowPassGain(long pointer, float gain);
	protected final static native int Channel_getLowPassGain(long pointer, FloatBuffer gain, long gain_);
	...
	protected final static native int Channel_setCallback(long pointer, boolean callback);
	...
	protected final static native int Channel_isVirtual(long pointer, ByteBuffer is, long is_);
	...
	protected final static native int Channel_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int ChannelGroup_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int DSP_showConfigDialog(long pointer, java.awt.Component hwnd, long hwndHwnd, boolean show);
	...
	protected final static native int DSP_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int DSPConnection_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	protected final static native String FMOD_ErrorString(int errCode);
	protected final static native long getHwnd(java.awt.Component component);
	...
	protected final static native int FmodEx_Memory_GetStats(IntBuffer currentalloced, long currentalloced_, IntBuffer maxalloced, long maxalloced_, boolean blocking);
	...
	protected final static native int Geometry_addPolygon(long pointer, float directocclusion, float reverbocclusion, boolean doublesided, int numvertices, long vertices, int verticesLen_, IntBuffer polygonindex, long polygonindex_);
	...
	protected final static native int Geometry_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int Reverb_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int Sound_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int SoundGroup_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
	...
	protected final static native int System_setFileSystem(long pointer, boolean useropen, boolean userclose, boolean userread, boolean userseek, boolean userasyncread, boolean userasynccancel, int blockalign);
	...
	protected final static native int System_loadPlugin(long pointer, byte[] filename, IntBuffer handle, long handle_, int priority);
	protected final static native int System_unloadPlugin(long pointer, int handle);
	protected final static native int System_getNumPlugins(long pointer, int plugintype, IntBuffer numplugins, long numplugins_);
	protected final static native int System_getPluginHandle(long pointer, int plugintype, int index, IntBuffer handle, long handle_);
	protected final static native int System_getPluginInfo(long pointer, int handle, IntBuffer plugintypePointer, ByteBuffer name, long name_, int namelen, IntBuffer version, long version_);
	protected final static native int System_setOutputByPlugin(long pointer, int handle);
	protected final static native int System_getOutputByPlugin(long pointer, IntBuffer handle, long handle_);
	protected final static native int System_createDSPByPlugin(long pointer, int handle, DSP dsp);
	protected final static native int System_createCodec(long pointer, long description, int priority);
	...
	protected final static native int System_getCPUUsage(long pointer, FloatBuffer dsp, long dsp_, FloatBuffer stream, long stream_, FloatBuffer geometry, long geometry_, FloatBuffer update, long update_, FloatBuffer total, long total_);
	...
	protected final static native int System_getRecordPosition(long pointer, int id, IntBuffer position, long position_);
	protected final static native int System_recordStart(long pointer, int id, long sound, boolean loop);
	protected final static native int System_recordStop(long pointer, int id);
	protected final static native int System_isRecording(long pointer, int id, ByteBuffer recording, long recording_);
	...
	protected final static native int System_getGeometryOcclusion(long pointer, long listener, long source, FloatBuffer direct, long direct_, FloatBuffer reverb, long reverb_);
	...
	protected final static native int System_getMemoryInfo(long pointer, int memorybits, int event_memorybits, IntBuffer memoryused, long memoryused_, long memoryused_details);
}
