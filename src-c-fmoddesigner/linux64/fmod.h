...
#define FMOD_VERSION    0x00043102
...
{                                   /*       MIN     MAX     DEFAULT  DESCRIPTION */
    int          Instance;          /* [w]   0     , 3     , 0      , Environment Instance. Simultaneous HW reverbs are possible on some platforms. (SUPPORTED:EAX4/SFX(3 instances) and Wii (2 instances)) */
