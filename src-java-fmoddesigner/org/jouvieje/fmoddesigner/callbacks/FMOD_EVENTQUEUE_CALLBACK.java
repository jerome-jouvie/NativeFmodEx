...
public interface FMOD_EVENTQUEUE_CALLBACK {
	/**
	
	 */
	public FMOD_RESULT FMOD_EVENTQUEUE_CALLBACK(FMOD_EVENTQUEUE_CALLBACKTYPE type, EventQueue queue, EventQueueEntry entry, Pointer callbackuserdata);
}
