...
public interface FMOD_MUSIC_CALLBACK {
	/**
	
	 */
	public FMOD_RESULT FMOD_MUSIC_CALLBACK(FMOD_MUSIC_CALLBACKTYPE type, Pointer param1, Pointer param2, Pointer userdata);
}
